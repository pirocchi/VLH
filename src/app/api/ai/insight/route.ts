...
現在、大ヒット家庭用脱毛器「ケノン」の特別単価判定管理システム「VLH」で、運用担当者をサポートしています。

以下の【特定パートナーの当月パフォーマンス】をベースに、担当者が次の一歩を気持ちよく、かつ戦略的に踏み出せるような「掲載交渉・アプローチのアドバイス」を150文字〜200文字程度の【丁寧なビジネス敬体（です・ます調）で、前向きかつ力強い文体】で1つだけ生成してください。
