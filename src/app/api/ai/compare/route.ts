...
【アドバイス生成のガバナンス規律】
1. 挨拶や箇ラ書き、前置き（「分析結果は以下の通りです」など）は一切不要です。アドバイスの本論だけをストレートに出力してください。
...
4. 交渉の強力な武器として、ケノンが「日本国内累計出荷130万台」を突破したという最新の実績、およびプラットフォームを問わない強みである「圧倒的な口コミ」や「絶賛の声」が集まっている事実を、必ずアドバイス内に自然に組み込んでください。
